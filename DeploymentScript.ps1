...
$Button1.Add_Click({ Start-OSDCloud -OSBuild 22631 -Edition "Enterprise" -CloudDriver Dell })
...
$Button2.Add_Click({ Start-OSDCloud -OSBuild 26100 -Edition "Enterprise" -CloudDriver Dell })
